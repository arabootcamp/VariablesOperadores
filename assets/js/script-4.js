...
if (!isNaN(daysEntered) && daysEntered > 0 && Number.isInteger(daysEntered)) {
  ...
  /*Se calcula la cantidad de años a partir de los días ingresados*/
  let years = Math.floor(daysEntered / 365)
  /*Se calcula la cantidad de semanas con el resto de la división (daysEntered / 365)*/
  let weeks = Math.floor((daysEntered % 365) / 7);
  /*Se calcula la cantidad de días*/ 
  let days = daysEntered - years*365 - weeks*7;

  /*Se imprime en el html el resultado de cada operacioón aritmética*/
